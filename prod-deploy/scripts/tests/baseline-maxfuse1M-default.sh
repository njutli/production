...
BW_LOG_DIR="/tmp/jfs-bw-default"
RESULTS_DIR="/tmp/opencode-baseline-maxfuse1M-default"
FSID="4f4e3ca0-8297-11f1-a671-97520597268c"
NIC_IF="enp139s0f0np0"
JUICEFS_MOUNT_OPTS="--max-uploads 150 --cache-size 0 --max-fuse-io 1M"
...
remount_jfs() {
    ...
    log "JuiceFS remounted OK (max_read=1M)"
}
