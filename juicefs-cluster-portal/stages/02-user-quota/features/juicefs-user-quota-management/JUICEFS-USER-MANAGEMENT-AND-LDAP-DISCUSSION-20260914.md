...
> 后续决定（2026-09-22）：本期采用路线A，最新实施依据见[LDAP统一用户管理实施与注意事项](JUICEFS-LDAP-USER-MANAGEMENT-IMPLEMENTATION-NOTES-20260922.md)。下文保留历史讨论，其中独立控制器分配ID、部署位置等设想不代表当前已确定配置；本期ID来自统一LDAP开户流程，不开发客户端助手。
