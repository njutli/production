#!/bin/bash
# Commands: full-bs256k warm-cache100g (patched v1.3.1)
# binary: /usr/local/bin/juicefs (patched, v1.3.1+2025-12-02.e0032b2a)

# format: 跳过（暖态复用冷态卷）

# mount
juicefs mount -d --cache-size 102400 --cache-dir /data/jfsCache  tikv://192.168.11.12:2379/juicefs-prod /mnt/juicefs
