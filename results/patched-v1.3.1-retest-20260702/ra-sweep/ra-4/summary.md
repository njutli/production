============================================================
RA Sweep ra=4 20260703-105118
============================================================
## 口径:
  block-size=256K, cache=0, max-readahead=4 MiB
...
### seqread prep (write 4G)
  seqread: READ=81.1 NIC_RX=4321.8

## 随机读 (3轮, bs=256K, 128jobs, iodepth=128, direct=1, runtime=60s)
  randread r1: READ=52.0 NIC_RX=7065.0
  randread r2: READ=54.8 NIC_RX=7110.6
  randread r3: READ=56.1 NIC_RX=7082.7
