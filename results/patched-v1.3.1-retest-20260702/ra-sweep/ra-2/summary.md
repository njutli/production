============================================================
RA Sweep ra=2 20260703-104213
============================================================
## 口径:
  block-size=256K, cache=0, max-readahead=2 MiB
...
### seqread prep (write 4G)
  seqread: READ=80.1 NIC_RX=4324.7

## 随机读 (3轮, bs=256K, 128jobs, iodepth=128, direct=1, runtime=60s)
  randread r1: READ=52.0 NIC_RX=7077.7
  randread r2: READ=54.6 NIC_RX=7082.7
  randread r3: READ=56.1 NIC_RX=7088.2
