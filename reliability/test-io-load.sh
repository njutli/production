...
ssh_to_client() {
    ...
    case "$cmd" in
        ...
        cat*result*) echo "$_MOCK_FIO_JSON" ;;
        cat*baseline*) echo "$_MOCK_FIO_BASELINE_JSON" ;;
    esac
}
