...
| 场景 | runtime | IOPS | P50 | P99 | Max(r) | Max(w) |
|------|---------|------|------|------|--------|--------|
| **基线（无故障）** | 93.0s | 233 | 17.1s | 17.1s | 88.1s | 88.9s |
| **FT-004（1 TiKV down）** | 95.0s | 242 | 17.1s | 17.1s | 89.2s | 90.6s |
| **FT-006（1 MON down）** | 98.0s | 250 | 17.1s | 17.1s | 89.3s | 90.2s |
| **FT-007（2 MON down，quorum 丢失）** | 125.0s | 214 | 17.1s | 17.1s | 101.6s | 105.7s |
| **FT-008（1 PD down）** | 100.0s | 177 | 17.1s | 17.1s | 99.1s | 99.1s |
